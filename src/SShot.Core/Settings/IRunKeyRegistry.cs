...
/// tests, under the rule that external dependencies in Core - P/Invoke, file I/O, registry -
/// must go through an interface. Without this, tests had to mutate the real user
